...
REGISTER_POLICY(RatingPartitionPolicy, RatingPartitionPolicy::evolutionary,
                EvoPartitionPolicy);
REGISTER_POLICY(RatingPartitionPolicy, RatingPartitionPolicy::block_quality,
                EvoBlockQualityPolicy);
REGISTER_POLICY(RatingPartitionPolicy, RatingPartitionPolicy::dangling_nodes,
                EvoDanglingNodesPolicy);
REGISTER_POLICY(RatingPartitionPolicy, RatingPartitionPolicy::dangling_nodes_new_initial_partition,
                EvoDanglingNodesNewInitialPartitionPolicy);
