...
struct EvolutionaryParameters {
  ...
  float block_quality_chance;
  float block_quality_contraction_limit_multiplier;
  ...
  mutable std::vector<int> block_quality;
  mutable std::vector<int> dangling_nodes;
...
inline std::ostream& operator<< (std::ostream& str, const EvolutionaryParameters& params) {
  ...
  str << "  Block Quality Chance                " << params.block_quality_chance << std::endl;
  str << "  Block Quality Contraction Limit Mult" << params.block_quality_contraction_limit_multiplier << std::endl;
